...
<div class="panel">
	<div class="panel-body">
	      <div class="col-md-6 col-sm-12">
	        <h3 class="animated fadeInLeft"> Edit Department | {{ config('app.name') }} </h3>
	        <p> Edit and update system department</p>
	    </div>
            ...
            <div class="d-flex no-block justify-content-end align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> <i class="fa fa-lock"></i> Edit Department </li>
                    </ol>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="{{ $department->name }}" class="form-control" id="Names" autofocus required> </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="parent_department" class="custom-select form-control" id="department1">
                                            <option value="{{ $department->parent_department }}">Select Parent Department</option>
                                            @foreach($departments as $odepartment)
                                                <option value="{{ $odepartment->id }}">{{ $odepartment->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="description" placeholder="Department description details" id="description11">{{ $department->description }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </section>
