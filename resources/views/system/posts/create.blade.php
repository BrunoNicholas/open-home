...
<div class="panel">
	<div class="panel-body">
	      <div class="col-md-6 col-sm-12">
	        <h3 class="animated fadeInLeft"> Add New Posts | {{ config('app.name') }} </h3>
    ...
    <div class="col-md-12 padding-0">
        <div class="col-md-9 padding-0">
            <div class="panel box-v4">
                <div class="panel-body">
                    <form action="{{ route('posts.store') }}" method="POST" class="tab-wizard wizard-circle">
                        @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="project_id" class="form-control" id="category1">
                                            <option value="">Selct Project</option>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" id="desc" placeholder="Enter the details to help understand the post more!"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="desc">More Support Informatio <span class="text-danger">*</span> :</label>
                                        <textarea name="more" class="form-control" id="desc" placeholder="Help provide related information if any!"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="date1">Post Date <span class="text-danger">*</span> :</label>
                                        <input type="date" name="post_date" class="form-control" id="date1" value="{{ date('Y-m-d') }}"> 
                                    </div>
                                </div>
                            </div>
                        </section>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="references" class="form-control" id="desc" placeholder="You can give references for the post as for validity and use of the communicated information!"></textarea>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <div div class="col-md-12 text-center">
                            <a href="{{ route('incidents.index') }}" class="btn btn-round btn-danger" onclick="return confirm('Are you sure you want to discard this post?\nThis will delete all it content!')">Discard</a>
                            <button type="submit" class="btn btn-round btn-primary">Add Post</button>
                        </div>                    
                    </form>
                </div>
            </div>
